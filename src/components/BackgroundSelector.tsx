    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-6 w-full max-w-lg shadow-2xl border border-white/30">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-slate-800">Sfondi</h2>
          <button
            onClick={onClose}
            ...
            >
              ...
              >
                <div className="absolute inset-0 opacity-30">
                  ...
                  <div className="absolute bottom-3 right-3 w-1 h-1 bg-white/40 rounded-full" />
                  <div className="absolute top-1/2 left-1/2 w-1.5 h-1.5 bg-white/50 rounded-full" />
                </div>
              </div>
